package com.irsyaad.dicodinglatihan.latihan3.gcmnetwork;
...
public class GcmNetworkManagerActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gcm_network_manager);
