package com.irsyaad.dicodinglatihan.latihan3.firebasedispatcher;
...
public class FirebaseDispatcherActivity extends AppCompatActivity implements View.OnClickListener {
    Button btnSetScheduler, btnCancelScheduler;
    FirebaseJobDispatcher mDispatcher;

    private String DISPATCHER_TAG = "mydispatcher";
    private String CITY = "Yogyakarta";
